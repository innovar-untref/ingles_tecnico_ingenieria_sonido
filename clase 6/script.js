const VOCABULARY = [
    ...
    { word: 'aware', meaning: 'ser consciente', category: 'default' },
    { word: 'degree', meaning: 'grado', category: 'default' },
    { word: 'quite', meaning: 'bastante', category: 'default' },
    { word: 'relate', meaning: 'relacionar(se)', category: 'default' },
    { word: 'involve', meaning: 'implicar', category: 'default' },
    { word: 'almost', meaning: 'casi', category: 'default' },
    { word: 'rate', meaning: 'velocidad / tasa', category: 'default' },
    { word: 'accurately', meaning: 'precisamente / con precisión', category: 'default' },
    { word: 'within', meaning: 'dentro', category: 'default' },
    { word: 'isolated', meaning: 'aislado', category: 'default' },
    { word: 'assess', meaning: 'evaluar', category: 'default' },
    { word: 'meet', meaning: 'cumplir', category: 'default' },
...
function initCrossword() {
    ...
    function buildCrossword() {
        const crosswordData = [
            { word: 'PURPOSE', x: 2, y: 1, dir: 'down', clue: 'propósito' },
            { word: 'DEGREE', x: 1, y: 3, dir: 'across', clue: 'grado' },
            { word: 'RELATE', x: 6, y: 1, dir: 'down', clue: 'relacionar(se)' },
            { word: 'INVOLVE', x: 4, y: 5, dir: 'across', clue: 'implicar' },
            { word: 'ALMOST', x: 9, y: 3, dir: 'down', clue: 'casi' },
            { word: 'WITHIN', x: 7, y: 7, dir: 'across', clue: 'dentro' },
            { word: 'ISOLATED', x: 11, y: 4, dir: 'down', clue: 'aislado' },
            { word: 'ACCURATELY', x: 3, y: 11, dir: 'across', clue: 'precisamente / con precisión' },
            { word: 'MEASURES', x: 5, y: 13, dir: 'across', clue: 'medidas' },
            { word: 'QUITE', x: 1, y: 9, dir: 'across', clue: 'bastante' }
        ];
