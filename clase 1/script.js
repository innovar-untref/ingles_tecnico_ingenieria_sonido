const VOCABULARY = [
    { word: 'recall', meaning: 'recordar', category: 'default' },
    { word: 'look away', meaning: 'mirar hacia otro lado', category: 'default' },
    { word: 'space', meaning: 'espaciar', category: 'default' },
    { word: 'amount', meaning: 'cantidad', category: 'default' },
    { word: 'handwriting', meaning: 'escritura a mano', category: 'default' },
    { word: 'yourself', meaning: 'vos mismo', category: 'default' },
    { word: 'take over', meaning: 'hacerse cargo', category: 'default' },
    { word: 'waste', meaning: 'desperdiciar', category: 'default' },
    { word: 'unless', meaning: 'a menos que', category: 'default' },
    { word: 'fool', meaning: 'engañar', category: 'default' },
    { word: 'worst', meaning: 'peor', category: 'default' },
    { word: 'be able to', meaning: 'poder', category: 'default' },
    { word: 'every', meaning: 'cada', category: 'default' },
    { word: 'toward', meaning: 'hacia', category: 'default' }
];
...
function initCrossword() {
    ...
    function buildCrossword() {
        const crosswordData = [
            { word: 'FOOL', x: 8, y: 6, dir: 'down', clue: 'engañar' },
            { word: 'SPACE', x: 5, y: 7, dir: 'across', clue: 'espaciar' },
            { word: 'LOOKAWAY', x: 7, y: 3, dir: 'down', clue: 'mirar hacia otro lado' },
            { word: 'BEABLETO', x: 1, y: 1, dir: 'across', clue: 'poder' },
            { word: 'AMOUNT', x: 8, y: 8, dir: 'down', clue: 'cantidad' },
            { word: 'TAKEOVER', x: 5, y: 8, dir: 'down', clue: 'hacerse cargo' },
            { word: 'WORST', x: 1, y: 2, dir: 'across', clue: 'peor' }
        ];
