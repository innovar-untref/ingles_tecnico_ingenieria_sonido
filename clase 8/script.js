const VOCABULARY = [
    { word: 'challenges', meaning: 'desafíos', category: 'default' },
    { word: 'research', meaning: 'investigación', category: 'default' },
    { word: 'further', meaning: 'más / adicional', category: 'default' },
    { word: 'consumer goods', meaning: 'bienes de consumo', category: 'default' },
    { word: 'measure', meaning: 'medir', category: 'default' },
    { word: 'lead to', meaning: 'llevar a', category: 'default' },
    { word: 'miss', meaning: 'perderse', category: 'default' },
    { word: 'it is worth', meaning: 'vale la pena', category: 'default' },
    { word: 'as long as', meaning: 'siempre y cuando', category: 'default' },
    { word: 'broadly', meaning: 'ampliamente', category: 'default' },
    { word: 'unwanted', meaning: 'no deseado', category: 'default' },
    { word: 'throughout', meaning: 'a través de todo / en todo', category: 'default' },
    { word: 'drive', meaning: 'empujar / impulsar', category: 'default' },
    { word: 'swap', meaning: 'intercambiar', category: 'default' },
...
function initCrossword() {
    ...
    function buildCrossword() {
        const crosswordData = [
            { word: 'CHALLENGES', x: 2, y: 1, dir: 'down', clue: 'desafíos' },
            { word: 'RESEARCH', x: 1, y: 3, dir: 'across', clue: 'investigación' },
            { word: 'FURTHER', x: 6, y: 1, dir: 'down', clue: 'más / adicional' },
            { word: 'MEASURE', x: 4, y: 5, dir: 'across', clue: 'medir' },
            { word: 'LEADTO', x: 9, y: 3, dir: 'down', clue: 'llevar a' },
            { word: 'BROADLY', x: 7, y: 7, dir: 'across', clue: 'ampliamente' },
            { word: 'UNWANTED', x: 11, y: 4, dir: 'down', clue: 'no deseado' },
            { word: 'THROUGHOUT', x: 3, y: 11, dir: 'across', clue: 'a través de todo / en todo' },
            { word: 'DRIVE', x: 5, y: 13, dir: 'across', clue: 'empujar / impulsar' },
            { word: 'SWAP', x: 1, y: 9, dir: 'across', clue: 'intercambiar' }
        ];
