const VOCABULARY = [
    { word: 'upgrade', meaning: 'actualizar / renovar', category: 'default' },
    { word: 'current', meaning: 'actual', category: 'default' },
    { word: 'overall', meaning: 'general / total', category: 'default' },
    { word: 'lack', meaning: 'carecer', category: 'default' },
    { word: 'outdated', meaning: 'anticuado / obsoleto', category: 'default' },
    { word: 'issues', meaning: 'problemas / cuestiones', category: 'default' },
    { word: 'downtime', meaning: 'tiempo de inactividad', category: 'default' },
    { word: 'enhance', meaning: 'mejorar / aumentar', category: 'default' },
    { word: 'rather than', meaning: 'en vez de', category: 'default' },
    { word: 'invest', meaning: 'invertir', category: 'default' },
    { word: 'features', meaning: 'características', category: 'default' },
    { word: 'deploy', meaning: 'desplegar', category: 'default' },
    { word: 'seek', meaning: 'buscar', category: 'default' },
    { word: 'approach', meaning: 'enfoque', category: 'default' },
...
function initCrossword() {
    ...
    function buildCrossword() {
        const crosswordData = [
            { word: 'UPGRADE', x: 2, y: 1, dir: 'down', clue: 'actualizar / renovar' },
            { word: 'CURRENT', x: 1, y: 3, dir: 'across', clue: 'actual' },
            { word: 'OVERALL', x: 6, y: 1, dir: 'down', clue: 'general / total' },
            { word: 'LACK', x: 4, y: 5, dir: 'across', clue: 'carecer' },
            { word: 'OUTDATED', x: 9, y: 2, dir: 'down', clue: 'anticuado / obsoleto' },
            { word: 'ISSUES', x: 7, y: 7, dir: 'across', clue: 'problemas / cuestiones' },
            { word: 'DOWNTIME', x: 11, y: 4, dir: 'down', clue: 'tiempo de inactividad' },
            { word: 'ENHANCE', x: 3, y: 11, dir: 'across', clue: 'mejorar / aumentar' },
            { word: 'INVEST', x: 5, y: 13, dir: 'across', clue: 'invertir' },
            { word: 'FEATURES', x: 0, y: 9, dir: 'across', clue: 'características' }
        ];
