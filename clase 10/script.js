const VOCABULARY = [
    { word: 'sources', meaning: 'fuentes', category: 'default' },
    { word: 'in fact', meaning: 'de hecho', category: 'default' },
    { word: 'brand', meaning: 'marca', category: 'default' },
    { word: 'the rear', meaning: 'la parte trasera', category: 'default' },
    { word: 'pattern', meaning: 'patrón', category: 'default' },
    { word: 'employ', meaning: 'emplear', category: 'default' },
    { word: 'both', meaning: 'ambos', category: 'default' },
    { word: 'field', meaning: 'campo', category: 'default' },
    { word: 'average', meaning: 'promedio', category: 'default' },
    { word: 'advantages', meaning: 'ventajas', category: 'default' },
    { word: 'expensive', meaning: 'caro', category: 'default' },
    { word: 'widely', meaning: 'ampliamente', category: 'default' },
    { word: 'reach', meaning: 'alcanzar', category: 'default' },
    { word: 'delay', meaning: 'retraso', category: 'default' },
    { word: 'add', meaning: 'agregar', category: 'default' }
];
...
function initCrossword() {
    ...
    function buildCrossword() {
        const crosswordData = [
            { word: 'SOURCES', x: 2, y: 1, dir: 'down', clue: 'fuentes' },
            { word: 'PATTERN', x: 1, y: 3, dir: 'across', clue: 'patrón' },
            { word: 'EMPLOY', x: 6, y: 1, dir: 'down', clue: 'emplear' },
            { word: 'BOTH', x: 4, y: 5, dir: 'across', clue: 'ambos' },
            { word: 'FIELD', x: 9, y: 3, dir: 'down', clue: 'campo' },
            { word: 'AVERAGE', x: 7, y: 7, dir: 'across', clue: 'promedio' },
            { word: 'EXPENSIVE', x: 11, y: 4, dir: 'down', clue: 'caro' },
            { word: 'WIDELY', x: 3, y: 11, dir: 'across', clue: 'ampliamente' },
            { word: 'DELAY', x: 5, y: 13, dir: 'across', clue: 'retraso' },
            { word: 'BRAND', x: 1, y: 9, dir: 'across', clue: 'marca' }
        ];
